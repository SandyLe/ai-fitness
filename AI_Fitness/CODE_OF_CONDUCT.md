...
项目维护者负责澄清行为准则的标准，并对任何不当行为采取适当和公正的纠正措施。

项目维护者有权并有责任删除、编辑或拒绝与本行为准则不符的评论、提交、代码、wiki 编辑、问题和其他贡献，或暂时或永久禁止任何贡献者，如果他们认为行为不当、威胁、冒犯或有害。
...
虐待、骚扰或其他不可接受的行为可以通过联系项目团队来报告。所有投诉都将得到审查和调查，并以项目团队认为必要和适当的方式做出回应。项目团队有义务对事件报告者保密。

项目维护者如果不遵守或执行行为准则，可能会面临项目领导其他成员确定的临时或永久性后果。
